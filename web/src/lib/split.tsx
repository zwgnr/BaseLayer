...
type PotionedComponent<
  T extends ComponentOrTagName,
  V extends Variants | undefined
> = (props: PropsWithVariants<T, V>) => ReactElement;

type PtnComponent<T extends ComponentOrTagName> = (
  props: PropsWithClassName<T>
) => ReactElement;

export function ptn<T extends ComponentOrTagName>(
  Component: T,
  classes: string
): PtnComponent<T> {
  return (props: PropsWithClassName<T>) => {
...
export function pv<
  T extends ComponentOrTagName,
  V extends Variants | undefined
>(Component: T, classesProp: ClassesProp<V>): PvComponent<T, V> {
