...
Locate and install [BaseLayer](https://marketplace.visualstudio.com/items?itemName=BaseLayer.baselayer) through the VScode marketplace.
...
### BaseLayer: init
 ...
 Automatically configures your project with everything you need. Here's a simplified version of the steps:
  ...
  3. The setup will automatically configure your global.css and tailwind.config files. It will also create an empty *components/base* directory. 
