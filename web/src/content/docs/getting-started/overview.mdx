...
Here is a Button component using the buttonPotion with several variants.

<div class="flex items-center justify-center w-full p-2">
<Button className={buttonPotion({ intent:"accent", state:"ghost" })}>
Button
</Button>
</div>
```tsx
...
<Button className={buttonPotion({ intent:"accent", state:"ghost" })}>Button</Button>;
```
