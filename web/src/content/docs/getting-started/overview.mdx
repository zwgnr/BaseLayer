...
In the above example, each slot from the Potion matches up perfectly with a sub component of the Ark Pin Input Component.

## Potion Variants

As you can see, Potion leverages the <a target="_blank" rel="noopener noreferrer" href="https://www.tailwind-variants.org/">Tailwind Variants</a> library to create reusable styles. This library allows for things such as Variants, Responsive Variants, Slots, overrides, and Conflict resolution  (Tailwind Merge is built in). 
