...
When running the init CLI command, a global.css file is created, as well as an updated tailwind.config. By doing that themes powered by CSS Variables can be installed and ready to use.
...
1. surface(1-3) - used for backgrounds
2. border, input, focus
3. text(1-6) - usually grays, use for text hierarchy
4. primary(100-900) - your main brand color
5. accent(100-900) - your accent brand color
