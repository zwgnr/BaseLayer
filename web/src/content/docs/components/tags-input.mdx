...
import { TagsInput } from '../../../Examples/React/TagsInput/TagsInput.tsx'
...
export const tagsInputPotion = tv({
  slots: {
    root: "w-full",
    control:
      "flex flex-wrap gap-2 rounded-lg border-2 border-surface-3 bg-surface p-3 text-text shadow-md transition duration-100 focus-within:z-10  focus-within:border-secondary focus-within:shadow-lg",
