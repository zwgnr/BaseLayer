...
<div class="p-4 w-full flex justify-center items-center bg-surface-2 rounded-md">
    <div className="flex gap-2 items-center">
      <div className={badge({ intent: "default" })}>
      Default
      </div>
      <div className={badge({ intent: "info" })}>
        Info
      </div>
      <div className={badge({ intent: "alert" })}>
        Alert
      </div>
    </div>
</div>
...
```tsx
<div className={badge({ intent: "default" })}>Default</div>
<div className={badge({ intent: "info" })}>Info</div>
<div className={badge({ intent: "alert" })}>Alert</div>
```
</div>
...
<div class="p-4 w-full flex justify-center items-center bg-surface-2 rounded-md">
    <div className="flex gap-2 items-center">
      <div className={badge({ size: "sm" })}>
      Small
      </div>
      <div className={badge({ size: "md" })}>
        Medium
      </div>
      <div className={badge({ large: "lg" })}>
        Large
      </div>
    </div>
</div>
