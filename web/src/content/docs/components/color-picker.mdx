...
arkDocs: https://ark-ui.com/docs/react/components/color-picker
---
---

import DemoTabs from '../../../components/DemoTabs.astro'
import Potion  from '../../../components/Potion.astro'
import { ColorPicker } from "../../../Examples/React/ColorPicker/ColorPicker.tsx"
...
<DemoTabs solidDisabled vueDisabled>
  <Fragment slot="react">
```tsx
import { colorPickerPotion } from "@/components/base/colorPickerPotion";
import {
  ColorPickerArea,
