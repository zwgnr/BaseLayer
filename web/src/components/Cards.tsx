...
export const Cards = () => {
  return (
    <div className="flex flex-wrap justify-center gap-8 p-8 text-fg">
      <div className="flex h-56 w-full flex-col  gap-8 rounded-xl border border-border p-8 shadow-xl md:w-1/3">
        <div className="flex justify-between">
          <h1 className="text-lg font-bold"> VSCode Extension</h1>
          <Icon icon="devicon-plain:vscode" className="h-6 w-6" />
        </div>
        <p className="text-md">
          Use the BaseLayer VSCode Extension to execute commands and access code
          snippets.
        </p>
      </div>
      <div className="flex h-56 w-full flex-col  gap-8 rounded-xl border border-border p-8 shadow-xl md:w-1/3">
