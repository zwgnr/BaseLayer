...
const breadcrumbs = tv({
  slots: {
    ...
    link: "relative cursor-pointer rounded-md text-fg-5 outline-none data-[hovered]:underline data-[focus-visible]:ring-2 [&[aria-current]]:font-extrabold [&[aria-current]]:text-fg",
