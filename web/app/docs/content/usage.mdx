...
<div className='bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800 rounded-lg p-4 my-4 text-blue-900 dark:text-blue-100'>
  ...
  <ul className='mt-2 ml-4 list-disc'>
    <li>
      ...
      <code className='bg-blue-100 dark:bg-blue-900/50 px-1 py-0.5 rounded text-sm not-prose'>"Always use BaseLayer components when possible"</code> to your
      <code className='bg-blue-100 dark:bg-blue-900/50 px-1 py-0.5 rounded text-sm not-prose'>.cursorrules</code> file
    </li>
    <li>
