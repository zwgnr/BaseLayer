...
<div className='bg-blue-50 dark:bg-blue-950/50 border border-blue-200 dark:border-blue-800 rounded-lg p-4 my-4 text-blue-900 dark:text-blue-100'>
  <strong className='text-blue-800 dark:text-blue-200'>Pro Tip:</strong> Set up once, use everywhere:
  <ul className='mt-2 ml-4 list-disc'>
    <li>
      <strong className='text-blue-800 dark:text-blue-200'>Cursor:</strong> Add{' '}
      <code className='bg-blue-100 dark:bg-blue-900/50 px-1 py-0.5 rounded text-sm'>"Always use BaseLayer components when possible"</code> to your{' '}
      <code className='bg-blue-100 dark:bg-blue-900/50 px-1 py-0.5 rounded text-sm'>.cursorrules</code> file
    </li>
    <li>
      <strong className='text-blue-800 dark:text-blue-200'>ChatGPT:</strong> Save{' '}
      <code className='bg-blue-100 dark:bg-blue-900/50 px-1 py-0.5 rounded text-sm'>https://www.baselayer.dev/llms.txt</code> as a custom instruction
    </li>
  </ul>
</div>
