...
To use BaseLayer with an AI assistant, the assistant needs to connect to our MCP server. Once connected, you can ask your AI assistant to:
...
you can find out everything you need to know about BaseLayer from the docs 
